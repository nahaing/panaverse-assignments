...
function addItemToShoppingCart(item: string, quantity: number){
...
function removeItemFromShoppingCart(item: string){
...
function updateQuantityOfItemInShoppingCart(item: string, newQuantity: number){
